...
public class EtfEpfDTO {
    ...
    public EtfEpfDTO(String customerID, String month, double etfAmount, double epfAmount) {
    ...
    public String toString() {
        return "EtfEpfDTO{" + "customerID=" + customerID + ", month=" + month + ", etfAmount=" + etfAmount + ", epfAmount=" + epfAmount + '}';
    }
