...
public class EtfEpfTM {
    ...
    public EtfEpfTM(String customerID, String month, double etfAmount, double epfAmount) {
    ...
    public String toString() {
        return "EtfEpfTM{" + "customerID=" + customerID + ", month=" + month + ", etfAmount=" + etfAmount + ", epfAmount=" + epfAmount + '}';
    }
