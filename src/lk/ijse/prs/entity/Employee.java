...
public class Employee {
    ...
    public Employee(String employeeID, String employeeTypeName, String name, String nic, String addressNo, String addressStreet, String addressVillage, String addressCity, String contactNoHome, String contactNoMobile, String otherDetail) {
    ...
    public String toString() {
        return "Employee{" + "employeeID=" + employeeID + ", employeeTypeName=" + employeeTypeName + ", name=" + name + ", nic=" + nic + ", addressNo=" + addressNo + ", addressStreet=" + addressStreet + ", addressVillage=" + addressVillage + ", addressCity=" + addressCity + ", contactNoHome=" + contactNoHome + ", contactNoMobile=" + contactNoMobile + ", otherDetail=" + otherDetail + '}';
    }
