...
public class Salary {
    ...
    public Salary(String EmployeeID, String month, double basicSalary, double noPay, double totalSalary, double grossSalary, double netSalary) {
    ...
    public String toString() {
        return "Salary{" + "EmployeeID=" + EmployeeID + ", month=" + month + ", basicSalary=" + basicSalary + ", noPay=" + noPay + ", totalSalary=" + totalSalary + ", grossSalary=" + grossSalary + ", netSalary=" + netSalary + '}';
    }
